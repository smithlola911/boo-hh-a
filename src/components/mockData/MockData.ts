...
export const mockAccounts: Account[] = [
  ...
  //     email: 'j*@gmail.com',
  //     jointNames: '',
  //     username: 'Greene669-expired',
  //     password: 'Greene@66907-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 'm*@gmail.com',
  //     jointNames: '',
  //     username: 'MichelleOwes1-expired',
  //     password: 'Michelle1@@@-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     jointNames: '',
  //     username: 'DavidG1304-expired',
  //     password: 'Ola303060-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  //     balance_usd: 27747.0
  ...
  //     jointNames: '',
  //     username: 'Robert2260-expired',
  //     password: 'saythetruth220-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 's*@gmail.com',
  //     jointNames: '',
  //     username: 'sarahbart12-expired',
  //     password: 'sarah992-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     jointNames: '',
  //     username: 'Morgan7790-expired',
  //     password: '@Morgan12345$$!28-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 'c*@gmail.com',
  //     jointNames: '',
  //     username: 'Carolina7790-expired',
  //     password: 'Athlete2288-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     jointNames: '',
  //     username: 'MHSA1987-expired',
  //     password: 'IncrediblyGodfearing112383$-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: '',
  //     jointNames: '',
  //     username: 'Melody0912-expired',
  //     password: 'Verdell1414-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 'r@gmail.com',
  //     jointNames: '',
  //     username: 'CartwrightF24-expired',
  //     password: 'Rsassy2021-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 't@gmail.com',
  //     jointNames: '',
  //     username: 'ThomasLeath24-expired',
  //     password: 'Leath@2779-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     email: 'b@gmail.com',
  //     jointNames: '',
  //     username: 'BernieGreen24-expired',
  //     password: 'Green@2779-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  ...
  //     username: 'Kinghenry@022-expired',
  //     password: 'Myking4life04-expired'
  //   },
  //   bank_details: {
  //     account_type: 'Checking',
  //     account_number: '',
  ...
  },
  {
    account_id: 'ACC057',
    holder: {
      firstName: 'Miranda Crace',
      email: 'mc**@gmail.com',
      createdOn: '9/23/2025', // m/d/y
      username: 'MirandaCrace21',
      password: 'MirandaJCrace2025'
    },
    bank_details: {
      account_type: 'Checking',
      isAccountNumber: true,
      balance_usd: 135000.0
    },
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '25217',
  ...
  },
  {
    account_id: 'ACC060',
    holder: {
      firstName: 'Thomas Schulenberg',
      email: 't**@gmail.com',
      createdOn: '11/07/2025', // m/d/y
      username: 'Thomas638',
      password: 'ThomasSchulenberg@76'
    },
    bank_details: {
      account_type: 'Checking',
      isAccountNumber: true,
      balance_usd: 750000.0
    },
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '25217',
    ...
    transaction_history: [
      ...
      {
        dateTime: 'September 13, 2017',
        description: 'Transfer from Summit Corp - XXXXXX6725',
        status: 'Success',
        amount_usd: 1550.0
      },
      {
        dateTime: 'September 6, 2017',
      ...
      {
        dateTime: 'November 30, 2015',
        description: 'VAT Fee - XXXXXX3345',
        status: 'Success',
        amount_usd: -62.5
      },
      {
        dateTime: 'September 12, 2015',
        description: 'Transfer from Ethan Johnson - XXXXXX3491',
        status: 'Success',
        amount_usd: 129000.0
      },
      {
        dateTime: 'July 4, 2015',
  ...
  },
  {
    account_id: 'ACC061',
    holder: {
      firstName: 'Laura Sarah',
      email: 'l**@gmail.com',
      createdOn: '11/08/2025', // m/d/y
      username: 'Laurasar0307',
      password: 'Nayra11@'
    },
    bank_details: {
      account_type: 'Checking',
  ...
  },
  {
    account_id: 'ACC063',
    holder: {
      firstName: 'David Fore',
      email: 'd**@gmail.com',
      createdOn: '11/28/2025', // m/d/y
      username: 'David_fore010',
      password: '@wasper0147'
    },
    bank_details: {
      account_type: 'Checking',
      isAccountNumber: true,
      balance_usd: 3250000.0
    },
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '25217',
  ...
  },
  {
    account_id: 'ACC064',
    holder: {
      firstName: 'Olaf Kutcher',
      email: 'olaf**@gmail.com',
      createdOn: '12/2/2025', // m/d/y
      username: 'Olafkutcher010',
      password: '@Olaf-0404'
    },
    bank_details: {
      account_type: 'Checking',
  ...
  },
  {
    ...
    transaction_mgs_code: {
      ...
      headerText: 'Dear Valued Customer,',
      lastStepText:
        'To complete this transaction, a mandatory VAT processing fee of $5000.00 is required This charge complies with updated financial regulations and ensures the secure and timely handling of all transactions. If you have any questions or need further assistance please feel free to reach out to us. Thank you',
      thankYouText: 'Thank you',
      wireDate: true
    },
    transaction_history: [
      ...
      {
        dateTime: 'June 15, 2013',
        description: 'Tax Refund Receivables LLC - XXXXXX2567',
        status: 'Success',
        amount_usd: 156672.0
      },
      {
        dateTime: 'May 25, 2013',
        description: 'Transaction fee - XXXXXX2327',
        status: 'Success',
        amount_usd: -35.0
      },
      ...
      {
        dateTime: 'March 12, 2013',
        description: 'Succession Planning Group - XXXXXX3345',
        status: 'Success',
        amount_usd: 195840.0
      },
      {
        dateTime: 'February 5, 2013',
        description: 'Transaction fee - XXXXXX2372',
        status: 'Success',
        amount_usd: -35.0
      },
      ...
      {
        dateTime: 'January 10, 2013',
        description: 'Estate Settlement Services - XXXXXX1254',
        status: 'Success',
        amount_usd: -10000.0
      },
      {
        dateTime: 'November 3, 2012',
        description: 'Transfer from PATRICK MILLER - XXXXXX0045',
        status: 'Success',
        amount_usd: 19650.48
      },
      {
        dateTime: 'October 25, 2012',
        description: 'Transfer from Federal deposit Insurance corp  - XXXXXX8429',
        status: 'Success',
        amount_usd: 15987.6
      },
      {
        dateTime: 'October 15, 2012',
        description: 'Transfer from NovaTech Solutions XXXXXX6542',
        status: 'Success',
        amount_usd: 14630.72
      },
      {
        dateTime: 'October 10, 2012',
        description: 'Transfer from Horizon Tech XXXXXX1256',
        status: 'Success',
        amount_usd: 22848.0
      },
      {
        dateTime: 'October 4, 2012',
        description: 'Transfer from Lisa Fernandez XXXXXX3623',
        status: 'Success',
        amount_usd: 8486.4
      },
      ...
      {
        dateTime: 'September 23, 2011',
        description: 'Transfer from Federal deposit Insurance corp - XXXXXX5668',
        status: 'Success',
        amount_usd: 20572.8
      },
      {
        dateTime: 'September 20, 2011',
        description: 'Transfer fee - XXXXXX5668',
        status: 'Success',
        amount_usd: -80.0
      },
      ...
      {
        dateTime: 'September 13, 2011',
        description: 'Transfer from Summit Corp - XXXXXX6725',
        status: 'Success',
        amount_usd: 2024.68
      },
      {
        dateTime: 'September 6, 2011',
        description: 'Transfer fee - XXXXXX1384',
        status: 'Success',
        amount_usd: -80.0
      },
      ...
      {
        dateTime: 'September 3, 2010',
        description: 'Transfer from Noah Collins - XXXXXX8464',
        status: 'Success',
        amount_usd: 69861.6
      },
      {
        dateTime: 'August 30, 2010',
        description: 'Transfer from Grace Mitchell - XXXXXX1029',
        status: 'Success',
        amount_usd: 58846.32
      },
      ...
      {
        dateTime: 'June 20, 2010',
        description: 'Transfer from Mason Lee - XXXXXX7890',
        status: 'Success',
        amount_usd: 22977.6
      },
      {
        dateTime: 'June 5, 2010',
        description: 'Transfer fee - XXXXXX1373',
        status: 'Success',
        amount_usd: -80.0
      },
      ...
      {
        dateTime: 'September 15, 2009',
        description: 'Transfer from Jacob Smith - XXXXXX9120',
        status: 'Success',
        amount_usd: 25322.0
      },
      {
        dateTime: 'July 18, 2009',
        description: 'Transfer fee - XXXXXX356',
        status: 'Success',
        amount_usd: -80.0
      },
      ...
      {
        dateTime: 'June 12, 2009',
        description: 'Transfer fee - XXXXXX1126',
        status: 'Success',
        amount_usd: -80.0
      },
      {
        dateTime: 'April 12, 2009',
        description: 'Transfer from Olivia Mitchelle - XXXXXX3664',
        status: 'Success',
        amount_usd: 32640.0
      },
  ...
  },
  {
    account_id: 'ACC066',
    holder: {
      firstName: 'Michelle Williams',
      email: 'm**@gmail.com',
      createdOn: '12/9/2025', // m/d/y
      username: 'MichelleWilliams010',
      password: 'Williams@128'
    },
     bank_details: {
      account_type: 'Checking',
      isAccountNumber: true,
  ...
  },
  {
    account_id: 'ACC067',
    holder: {
      firstName: 'Christian A. Morales',
      email: 'c**@gmail.com',
      createdOn: '12/14/2025', // m/d/y
      username: 'ChristianMorales010',
      password: 'Morales@128'
    },
     bank_details: {
      account_type: 'Checking',
      isAccountNumber: true,
  ...
  },
  {
    ...
    transaction_mgs_code: {
      transaction_text_msg: 'To continue this transaction, please enter the code sent to you',
      transaction_code: '2637',
      headerText: 'Dear Valued Customer,',
      lastStepText:
        'Your Account is on Hold. You can’t make any transactions until you have up to 0.98333 of your available funds. please contact your bank manager for assistance.',
      thankYouText: 'Thank you',
      wireDate: true
    },
    transaction_history: [
